...
export const RULES = { style: 'title',
  // one style for the whole sheet: the street-type abbreviation with its dot
  // and a capital where a name or one of its " - " / "(" parts begins
  stopRe: [
    [/(^|[\s(])(Av|Pg|Pl|Ctra|Rbla|Rda|Trav|Ptge)(?= )/g, '$1$2.'],
    [/\b(av|c|ctra|pl|pg|rbla|pol|rda|rtda|ptge|urb)\.(?=\p{Lu}(?!\.))/giu, '$1. '],
    [/(^|\s-\s|\(|\s\/\s)(\p{Ll})/gu, (m, a, b) => a + b.toUpperCase()],
  ],
  stops: {
    'ctra. Conreria (pl. Vila -Ajuntament)) (D)': 'Ctra. Conreria (Pl. Vila - Ajuntament) (D)',
    'Carretera D´horta (centre De Formació Flor De Maig': 'Carretera d\'Horta (Centre de Formació Flor de Maig)',
    'Carretera Cerdanyola / Avinguda De Les Roquetes (C': 'Carretera Cerdanyola / Avinguda de les Roquetes',
    'Plaça: Major Del Rectoret (estació Les Planes': 'Plaça Major del Rectoret (Estació les Planes)',
    'Carretera De Rubí, Km14,5 / Carrer De Prat De La r': 'Carretera de Rubí, Km 14,5 / Carrer de Prat de la Riba',
  },
  mergeDirs: ['Linia Blava Tornada'],
  keys: { 'Linia Blava': 'Línia Blava', 'Linia Blava Tornada': 'Línia Blava', 'FUNICULAR': 'Funicular', '803 804 805': '803/804/805' },
};
